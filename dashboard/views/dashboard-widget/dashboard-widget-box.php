...
<script type="text/javascript">
    ...
    window.addEventListener('load', (e) => {
        ...
        DM.init({
            ...
            apiSecret: "<?php echo esc_js( $options['api_secret'] ); ?>",
            ...
            if (response.session) {
                DM.api('/me', {
                    ...
                    if (userInfo.error) {
                        ...
                        statusText.innerHTML = '<span class="dm--disconnected"></span> you\'re not connected, please sign in <a href="<?php echo esc_url( get_dashboard_url() ); ?>admin.php?page=dm-connect">here</a>'
