...
<h1 class="wp-heading-inline">
    <?php echo esc_html('Manual Embed Settings'); ?>
</h1>

<hr class="wp-header-end">

<nav class="nav-tab-wrapper wp-clearfix">
    <a href="<?php echo esc_url( get_bloginfo('wpurl') ); ?>/wp-admin/admin.php?page=dm-manual-embed-settings"
       class="nav-tab<?php echo $tab === 'playback' ? ' nav-tab-active' : ''; ?>"
    <?php echo $tab === 'playback' ? ' aria-current="page' : ''; ?>">Playback Settings</a>
    <a href="<?php echo esc_url( get_bloginfo('wpurl') ); ?>/wp-admin/admin.php?page=dm-manual-embed-settings&tab=content"
       class="nav-tab<?php echo $tab === 'content' ? ' nav-tab-active' : ''; ?>"
    <?php echo $tab === 'content' ? ' aria-current="page' : ''; ?>">Content Settings</a>
    <a href="<?php echo esc_url( get_bloginfo('wpurl') ); ?>/wp-admin/admin.php?page=dm-manual-embed-settings&tab=player"
