...
<form action="<?php echo get_admin_url() . 'admin.php?page=dm-manual-embed-settings&action=save_data'; ?>" method="post">
    ...
    <table class="form-table  dm-form-table" role="presentation">
        ...
        <tr>
            <th scope="row"><label for="player-id"><?php echo __('Manual Embed Player ID'); ?> <span class="detail-info">?<span class="tooltip">to create or modify a player template, refer to this page <a href="https://www.dailymotion.com/partner/embed/players">in your dailymotion partner HQ</a></span></span></label></th>
            <td>
