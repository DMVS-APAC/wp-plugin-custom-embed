 ...
 * the database.
 *
 * If user is not define any constant, it will get `AUTH_KEY` and `NONCE_KEY`
 * generated by WordPress Salt.
 *
 */
...
class Crypt {
    ...
    public static function encryptString($string): string {
        $key = hash('sha256', DM_AUTH_KEY);
        $iv = substr(hash('sha256', DM_NONCE_KEY), 0, 16);
